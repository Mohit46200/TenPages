...
import { FiUser, FiMenu, FiX, FiArrowUpRight, FiHome } from "react-icons/fi";

import { useAuth } from "../../context/AuthContext";

// This header is only used inside the admin area (AdminLayout) — the public
// storefront has no navbar, since there's no customer account area to link
// to. Buying a book never requires signing in.
